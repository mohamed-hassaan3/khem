...
/** A new offer. Both target sets are pickers over the live catalog, never free text. */
...
export default async function NewOfferPage({
  ...
  return (
    <>
      ...
      <AdminPageHeader
        title="New offer"
        description="Buy X, get Y. What the offer takes off is decided by the database when an order is placed — this screen describes the rule."
      />
