 ...
 *
 * `PENDING` maps to nothing — see the note on `OrderMailKind`. `PROCESSING`
 * reuses the confirmation, because a desk pulling an order forward is telling
 * the customer what checkout would have.
 *
